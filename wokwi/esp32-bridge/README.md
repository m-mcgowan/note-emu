# esp32-bridge — note-c + note-cpp coexistence with note-emu

[![Simulate in Wokwi](https://img.shields.io/badge/Simulate-Wokwi-AAB42F?logo=espressif)](https://wokwi.com/projects/470467610960276481)
...
<!-- snippet:wokwi/esp32-bridge/sample-output.txt:1-18 -->
```text
note-emu on Wokwi (bridge: note-c + note-cpp)
...
note-emu: billing-accounts -> rc=0 http=200 [397 ms]
...
note-emu: POST /v1/write (101 bytes) -> rc=0 http=200 [474 ms]
note-emu: POST /v1/read -> rc=0 http=200 bytes=26 [72 ms]
  < {}
hub.set (note-c): OK
  > {"req":"card.version","id":1}
note-emu: POST /v1/write (31 bytes) -> rc=0 http=200 [122 ms]
