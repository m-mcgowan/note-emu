...
<!-- snippet:wokwi/esp32-notecpp/sample-output.txt:1-18 -->
```text
note-emu on Wokwi (note-cpp)
...
note-emu: billing-accounts -> rc=0 http=200 [374 ms]
...
note-emu: ready (uid=00000000-0000-0000-0000-000000000000)
  > {"req":"hub.set","product":"com.example.you:notecpp-demo","mode":"continuous"}
note-emu: POST /v1/write (105 bytes) -> rc=0 http=200 [504 ms]
